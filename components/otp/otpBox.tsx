...
//               <button
//               className="group relative w-full h-[58px] bg-black text-white rounded-full overflow-hidden transition-all duration-500 hover:shadow-[0_20px_40px_rgba(0,0,0,0.3)] active:scale-[0.97] cursor-pointer disabled:cursor-wait"
//               onClick={handleSubmit}
//               disabled={isPending}
//             >
//               <LoaderButton title="Verify Otp" loadingText="Verifying..." isPending={isPending} type/>
//               </button> 
